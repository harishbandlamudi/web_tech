$(document).ready(function(){
    ...
    $('.start').click(function(){
        ...
        var car4_time = Math.floor((Math.random() * 5000) + 1);
        var car5_time = Math.floor((Math.random() * 5000) + 1);
        ...
        $('#car4').animate({left: RaceTrackWidth},car4_time);
        $('#car5').animate({left: RaceTrackWidth},car5_time);
    })
